...
<div class="container px-4">
  <div class="row gx-5">
    <div class="col">
<form method="post" action="http://localhost:8888/api/users">
  <fieldset>
    ...
    <div>
      ...
      <input type="password" class="form-control" id="inputPassword1" name="password" placeholder="Password" autocomplete="off">
    </div>
    <div>
